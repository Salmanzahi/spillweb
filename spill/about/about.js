...
class cardOne extends HTMLElement{
    constructor() {
        ...
        this.foto = this.getAttribute('foto') ? this.getAttribute('foto') : "../IMG/temp_4x3.png";

        this.innerHTML = 
        `
            <div class="card-one-style">
                <img class="card-stamp" src="../IMG/Square_Black.svg" alt=""/>
                ...
                <div class="card-body">
                    ...
                    <div class="card-img">
                        ...
                        <img class="card-spill" src="../IMG/Horizontal_Black.svg" alt="SPILL"/>
                    </div>
                </div>
            </div>
        `;
